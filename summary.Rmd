...
While median income and COVID death rates show a clear negative relationship, the chart above has a very slight upward trend. It compares park acreage per capita to the percentage of non-Hispanic white residents. It shows zip codes with the lowest park acreage per capita have a slightly lower percentage of non-Hispanic white residents compared to zip codes with the highest park acreage per capita. 
<br>
...
The chart above displays the relationship between median household income and COVID-19 death rate and shows that lower income zip codes tend to have the highest COVID-19 death rates and higher income zip codes have the lowest COVID-19 death rates.  
